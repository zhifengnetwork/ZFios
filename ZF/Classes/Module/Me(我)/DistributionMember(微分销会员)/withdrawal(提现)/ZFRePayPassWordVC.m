...
@implementation ZFRePayPassWordVC
...
- (void)nextButtonDidClick
{
    ...
    ZWeakSelf
    [http_user FindPwd:self.phoneNumber password:password password2:twoPassword scene:6 success:^(id responseObject)
     {

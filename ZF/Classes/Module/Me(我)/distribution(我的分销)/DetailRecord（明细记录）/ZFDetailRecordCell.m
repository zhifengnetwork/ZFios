...
#import "ZFTool.h"
@interface ZFDetailRecordCell()
@property (nonatomic, strong)UILabel *orderIDLabel;
@property (nonatomic, strong)UILabel *priceLabel;
@property (nonatomic, strong)UILabel *promptLabel;
@end
@implementation ZFDetailRecordCell
...
- (void)setRecordModel:(ZFDetailDistModel *)recordModel{
    ...
    _orderIDLabel.text = [ZFTool dateText:[NSString stringWithFormat:@"%ld",(long)_recordModel.change_time]];
    _priceLabel.text = [NSString stringWithFormat:@"￥%@",_recordModel.user_money];
    _promptLabel.text = _recordModel.desc;
}
@end

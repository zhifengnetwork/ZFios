...
@interface ZFDetailRecordVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ZFDetailRecordVC

static NSString *const ZFDetailRecordCellID = @"ZFDetailRecordCellID";
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"佣金明细";
    [self setupUI];
...
- (void)loadData{
    [http_mine commision:^(id responseObject) {
...
- (UITableView *)tableView{
    if (_tableView == nil) {
        ...
        [_tableView registerClass:[ZFDetailRecordCell class] forCellReuseIdentifier:ZFDetailRecordCellID];
    }return _tableView;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ZFDetailRecordCell *cell = [tableView dequeueReusableCellWithIdentifier:ZFDetailRecordCellID forIndexPath:indexPath];
